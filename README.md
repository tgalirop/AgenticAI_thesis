...
Η μελέτη οργανώνεται γύρω από τα ακόλουθα ερευνητικά ερωτήματα:

- **RQ1:** Μπορεί ένας Agentic AI μηχανισμός να εντοπίζει αυτόματα προβλήματα ποιότητας και μοντελοποίησης σε ένα μεγάλης κλίμακας FinTech dataset;
- **RQ2:** Μπορεί ο Agent να επιλέγει και να εφαρμόζει κατάλληλες τεχνικές preprocessing χωρίς συνεχή ανθρώπινη παρέμβαση;
- **RQ3:** Παρουσιάζουν τα μοντέλα μετά το Agentic AI preprocessing καλύτερη απόδοση από τα ίδια μοντέλα με συμβατικό, προκαθορισμένο preprocessing;
- **RQ4:** Είναι οι διαφορές στην απόδοση στατιστικά σημαντικές και πρακτικά ουσιώδεις;
- **RQ5:** Ποιο είναι το πρόσθετο υπολογιστικό κόστος του Agentic AI και δικαιολογείται από τη βελτίωση της ποιότητας και της προβλεπτικής απόδοσης;

Η βασική ερευνητική υπόθεση είναι:

```text
H₁: μΔ > 0
```

όπου `Δ` είναι η διαφορά μιας επιλεγμένης μετρικής μεταξύ Agentic και conventional pipeline. Η μηδενική υπόθεση είναι:

```text
H₀: μΔ = 0
```

Η μη επιβεβαίωση της θετικής υπόθεσης δεν αποτελεί αποτυχία. Εάν ο Agent αυξάνει την πολυπλοκότητα ή το κόστος χωρίς στατιστικά ή πρακτικά σημαντική βελτίωση, αυτό αποτελεί επίσης έγκυρο ερευνητικό αποτέλεσμα.
